...
export default function Initial() {
  ...
  return (
    <div >
     ...
     <div className="m1" onClick={prohibit}>
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
                ...
                <div className="carousel-inner">
                  <div className="carousel-item active">
                    <img src="https://assets.myntassets.com/f_webp,w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2022/7/28/84b6a214-9eb3-49eb-9f9d-72cec56ec5d71659019908592-Indian-Wear_DK--1-.jpg" className="d-block w-100" alt="..."/>
                  </div>
                  ...
                  <div className="carousel-item">
                    <img src="https://assets.myntassets.com/f_webp,w_980,c_limit,fl_progressive,dpr_2.0/assets/images/2022/5/31/4031994d-9092-4aa7-aea1-f52f2ae5194f1654006594976-Activewear_DK.jpg " className="d-block w-100" alt="..."/>
                  </div>
                </div>
...
<div className="footer-left">
    ...
    <p className="footer-links" onClick={prohibit}>
...
<div className="footer-center">
    ...
    <div>
        ...
        <p><a href="mailto:nikhilsingh118089">nikhilsingh118089@gmail.com</a></p>
    </div>
</div>
<div className="footer-right">
    ...
    <div className="footer-icons">
        ...
        <a href="https://www.x.com" target = "_blank"  rel="noopener noreferrer" ><i className="fa fa-twitter"></i></a>
